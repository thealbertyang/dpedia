...
class ApiFormController extends Controller {
	...
	public function respondInvalid($message = 'Error with validation.', $errors = null){
		return $this->setStatusCode(422)->respond($message, $errors);
	}

	public function respondError($message = 'There was an error.', $errors = null){
		return $this->setStatusCode(422)->respond($message, $errors);
	}

	public function respondDuplicate($message = 'Duplicate Entry.', $errors = null){
