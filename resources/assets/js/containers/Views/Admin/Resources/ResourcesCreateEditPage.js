				    	...
				    	<div className="col-md-8">
				    		<div className="card">
							    <div className="card-header">
							    	<h5 className="heading">{this.props.type == "EDIT" && 'Editing' || this.props.type == "CREATE" && 'Creating'} Resource</h5>
							    </div>
						...
						<div className="col-md-4">
							<div className="card">
							    ...
							    <div className="card-footer">
						        	...
						        	<Link to={`${config.ADMIN.DIR}/resources`} className="btn btn-secondary">Close</Link>
								</div>
							</div>
							<div className="card">
								<div className="card-header">
