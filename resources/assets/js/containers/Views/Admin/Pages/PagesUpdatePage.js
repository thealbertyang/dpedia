...
export class PagesUpdatePage extends React.Component { 
	constructor(props){
		super(props);	
	...
	render(){
		...
		return (
			<IndexCreateEditContainer type="UPDATE" title="Pages" matchUrl={this.props.match.url}>
				<PagesCreateUpdateForm type="UPDATE" title="Pages" matchUrl={this.props.match.url}/>
			</IndexCreateEditContainer>
		)
	}
}

export default PagesUpdatePage = connect((store) => {
	return {
