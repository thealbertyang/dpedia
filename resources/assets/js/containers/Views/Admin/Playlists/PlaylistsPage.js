...
@connect((store) => {
	return {
		...
		results: store.playlists.results,
	}
})
export class PlaylistsPage extends React.Component {
	...
	componentDidUpdate(prevProps, prevState){
		...
		//if next page was called then we want to update playlists list, when it does update, we don't want it to update again if it's the same page now
	...
	render(){
		return (
			<IndexCreateEditContainer type="INDEX" title="Playlists" matchUrl={this.props.match.url}>
