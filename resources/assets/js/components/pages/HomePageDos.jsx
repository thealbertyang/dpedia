...
export class HomePageDos extends React.Component {
	constructor(props){
		super(props)
		this.state = { isActiveNav: false, scrollTop: 0, value: '', suggestions: [], isLoading: false };
	...
	const inputProps = {
	  placeholder: 'Ex. Food, Medicine, Iphone, Gyms etc..',
	  value,
	  onChange: this.onChange
		...
		return (
			<div className="page home">
				...
				<div className={`loader-overlay col-md-10 ${this.props.filter_status == 'set_results_filter' ? 'loading' : ''}`}>
				</div>
				<SlideNavbarWrapper>
					<div className="row no-gutters">
						...
						<div className={`content-container col-md-12 col-lg-10 ${this.props.filter_status == 'set_results_filter' ? 'loading' : ''}`}>
							<div className="main__header container-fluid">
								<div className="row align-center text-center">
									<div className="col-md-10 m-auto">
										...
										<h1 className="heading mt-5">Enter a topic, we will do the rest</h1>
										<form className="form form__search" onSubmit={(e)=>{e.preventDefault(); console.log('TEST',this.props.filter); this.props.dispatch(getResults(this.state.value, this.props.filter)); }}>	
											<div className="row no-gutters align-center text-center mt-4">
												...
												<div className="col-md-12 mt-4">
													<input id="checkbox1" type="checkbox" /><label htmlFor="checkbox1">Results near me</label>
												</div>
											</div>
										</form>
									</div>
									<div className="col-md-8 mt-4">
										...
										<a href="#" className="text-center">Share results</a>
									</div>
								</div>
							</div>
